...
import { Sparkles, Rocket, Users, Calendar, ArrowRight, Instagram, Facebook, Linkedin } from "lucide-react";
  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden">
        <div className="container pt-20 pb-24 md:pt-32 md:pb-32 text-center">
          <motion.div
          ...
          {/* Stats */}
          <div className="mt-20 grid grid-cols-3 gap-3 md:gap-6 max-w-3xl mx-auto">
            {stats.map((s, i) => {
              const Icon = s.icon;
            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {publishedEvents.map((e, i) => (
                <motion.div
                  ...
                  className="glass rounded-xl p-5 hover:border-gold/40 transition-smooth"
                >
                  ...
                  <Button asChild variant="link" className="mt-3 px-0 text-primary">
                    <Link to={`/events/${e.id}`}>View details <ArrowRight className="ml-1 h-3 w-3" /></Link>
                  </Button>
                </motion.div>
              ))}
            </div>
